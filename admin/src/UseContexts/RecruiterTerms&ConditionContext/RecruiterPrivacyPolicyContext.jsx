...
export const RecruiterPrivacyContext = createContext();

const API_URL = `${
  import.meta.env.VITE_API_BASE_URL
}/api/admin/recruiter-privacy-policy`;

const RecruiterPrivacyPolicyContext = ({ children }) => {
  ...
  return (
    <>
      <RecruiterPrivacyContext.Provider
        value={{
          privacy,
          loading,
          addPrivacy,
...
export default RecruiterPrivacyPolicyContext;
