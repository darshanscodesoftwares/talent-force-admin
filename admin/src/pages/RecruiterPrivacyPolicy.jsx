...
import RecruiterPrivacyAdd from "../RecruiterTermsCondition/RecruiterPrivacyAdd";
const RecruiterPrivacyPolicy = () => {
  const { privacy, loading, deletePrivacy } = useContext(
    RecruiterPrivacyContext
  );
