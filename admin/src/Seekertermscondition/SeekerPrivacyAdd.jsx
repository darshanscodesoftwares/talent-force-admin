...
import "./SeekerPrivacyAdd.css";

import { SeekerPrivacyContext } from "../UseContexts/SeekerTerms&ConditionContext/SeekerPrivacyPolicyContext";

const SeekerPrivacyAdd = ({ onClose, editData = null }) => {
  const { privacy, loading, addPrivacy, updatePrivacy, deletePrivacy } =
    useContext(SeekerPrivacyContext);
...
export default SeekerPrivacyAdd;
